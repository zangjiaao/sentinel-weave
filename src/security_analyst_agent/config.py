...
DEFAULT_HERMES_PATROL_TRIGGER_MODE = os.getenv("HERMES_PATROL_TRIGGER_MODE", "openai")
...
DEFAULT_OPENAI_USER_AGENT = (os.getenv("OPENAI_USER_AGENT") or "codex_cli_rs/0.65.0").strip()
DEFAULT_OPENAI_REASONING_EFFORT = (os.getenv("OPENAI_REASONING_EFFORT") or "high").strip().lower()
DEFAULT_OPENAI_WIRE_API = (os.getenv("OPENAI_WIRE_API") or "responses").strip().lower()
DEFAULT_OPENAI_ENABLE_CHAT_FALLBACK = _bool_env("OPENAI_ENABLE_CHAT_FALLBACK", True)
...
DEFAULT_OPENAI_PATROL_SESSION_MAX_RUNS = _int_env("OPENAI_PATROL_SESSION_MAX_RUNS", 24)
DEFAULT_OPENAI_PATROL_SESSION_MAX_INPUT_TOKENS = _int_env("OPENAI_PATROL_SESSION_MAX_INPUT_TOKENS", 300000)
DEFAULT_OPENAI_PATROL_RETRY_FRESH_ON_NO_TOOL = _bool_env("OPENAI_PATROL_RETRY_FRESH_ON_NO_TOOL", True)
DEFAULT_OPENAI_PATROL_OBJECTIVE_MODE = _bool_env("OPENAI_PATROL_OBJECTIVE_MODE", True)
DEFAULT_MCP_ALERT_FETCH_AUTO_CLUSTER_THRESHOLD = _int_env("MCP_ALERT_FETCH_AUTO_CLUSTER_THRESHOLD", 8)
