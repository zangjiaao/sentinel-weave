...
PROMPT_GUIDANCE = {
    ...
    "actor.case-list": '{"case_id":"<case_id>"}',
    "actor.case-get": '{"case_actor_id":"<case_actor_id>"}',
    "actor.case-find-candidates": '{"case_id":"<case_id>","alert_id":"<alert_id>","limit":5}',
    "actor.case-upsert": '{"case_actor_id":"<case_actor_id>","case_id":"<case_id>","label":"<label>","status":"active","profile_confidence":0.86,"risk_level":"high","is_primary":true,"current_stage":"command_execution","first_seen_at":"2026-04-10T09:10:00+08:00","last_seen_at":"2026-04-12T11:03:00+08:00","summary":"<summary>"}',
    "actor.case-add-observation": '{"case_actor_id":"<case_actor_id>","observation_type":"src_ip","observation_key":"198.51.100.77","observation_value":"198.51.100.77","confidence":0.9,"first_seen_at":"2026-04-12T11:03:00+08:00","last_seen_at":"2026-04-12T11:03:00+08:00","source_count":1}',
    "actor.case-link": '{"case_actor_id":"<case_actor_id>","target_type":"alert","target_id":"<alert_id>","link_confidence":0.9,"link_reason":"<why>"}',
    "case.explain-link": "\n".join(
        [
            "以下内容仅在 `secagent-patrol` skill 不可用时作为兜底说明。",
